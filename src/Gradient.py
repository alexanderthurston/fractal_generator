...
class Gradient:
    ...
    def getColor(self, index):
        if self.__type == "mandelbrot":
            return self.__mandelbrotGradient[index]
        if self.__type == "julia":
            return self.__juliaGradient[index]
    def getLength(self):
        if self.__type == "mandelbrot":
            return len(self.__mandelbrotGradient)
        if self.__type == "julia":
            return len(self.__juliaGradient)